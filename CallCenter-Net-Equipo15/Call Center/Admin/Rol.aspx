<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CRUD.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Rol.aspx.cs" Inherits="Call_Center.ABML.Rol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upModal" runat="server">
            <ContentTemplate>
                <div id="modalRol" runat="server" style="display: none;">
                    <div class="custom-modal card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txbRolNombre" runat="server" placeholder="Nombre:" CssClass="form-control"></asp:TextBox>
                                <div class="alert alert-danger" id="alertRol" runat="server" style="display: none;">
                        ...
                        <div class="card-footer">
                            ...
                            <asp:Button ID="btnRolSub" runat="server" Text="Confirmar" OnClick="submitModal" CssClass="btn btn-primary" />
                            <asp:Button ID="btnRolCancelar" runat="server" Text="Cancelar" OnClick="cancelarModal" CssClass="btn btn-secondary" />
