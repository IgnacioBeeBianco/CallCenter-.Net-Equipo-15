...
INSERT INTO Cuenta (email, password_, id_rol) VALUES 
    ...
    ('cliente2@gmail.com', 'cliente123', 4);
...
INSERT INTO Usuario (nombre, apellido, dni, domicilio, telefono, genero, cuenta_id) VALUES 
    ...
    ('Cliente2', 'EjemploCliente2', '4123412', 'Calle XYZ', '5556667777', 'F', 5);
...
VALUES
    ...
    (5, 2, '2023-11-15 10:00:00', '2023-11-16 15:30:00', 1, 1, 1, 'Cerrado con éxito', 'Problema de red en la oficina principal');
